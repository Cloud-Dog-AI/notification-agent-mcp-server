...
"""Application Tests for Image Markdown Reference"""
import sys
...
class TestImageMarkdownReference:
    def test_markdown_reference_scenario(self, media_renderer):
        ...
        check_test_dependencies(
            ...
            requires_api=True,
            test_name="test_markdown_reference_scenario",
        )

        result = media_renderer.render_image_for_markdown(
            "http://example.com/image.png",
            "Test Image",
        )
        assert "![Test Image](http://example.com/image.png)" in result
