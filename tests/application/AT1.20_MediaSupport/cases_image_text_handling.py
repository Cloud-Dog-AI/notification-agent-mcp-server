...
"""Application Tests for Image Text Handling"""
import sys
...
class TestImageTextHandling:
    def test_text_handling_scenario(self, media_renderer):
        ...
        check_test_dependencies(
            ...
            requires_api=True,
            test_name="test_text_handling_scenario",
        )

        result = media_renderer.render_image_for_text(
