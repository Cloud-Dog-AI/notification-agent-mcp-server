...
"""Application Tests for Image PDF Rendering"""
import io
import sys
...
class TestImagePDFRendering:
    def test_pdf_rendering_scenario(self, media_renderer, sample_image):
        ...
        check_test_dependencies(
            ...
            requires_api=True,
            test_name="test_pdf_rendering_scenario",
        )

        image_reader = media_renderer.render_image_for_pdf(sample_image, "png")
        # May be None if ReportLab not available
        # This is acceptable for basic test
